...
<div class="wysiwyg">
    <ul>
        <li> [Contrat de partenariat relatif à la mise à disposition de volets du CI-SIS](../../assets/docs/Contrat_Cadre_UP_Syntaxe.zip)</li> <!-- TODO : Référencer le contrat UP_externe syntaxique -->
        <li> [Contrat de partenariat relatif à la mise à disposition de terminologies](../../assets/docs/Contrat_Cadre_UP_Semantique.zip)</li> <!-- TODO : Référencer le contrat UP_externe sémantique -->
    </ul>
</div>
