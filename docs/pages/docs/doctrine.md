...
- A défaut, consultation dse acteurs pour identification de la norme ou du standard à utiliser pour prendre en compte le besoin d'interopérabilité.
...
- Certains profils IHE en trial implementation ne sont pas encore tout à fait stables (ex. les profils qui n’ont pas encore eu l’occasion d’être testés lors d’un Connectathon5).
...
- Les guides d’implémentation FHIR au statut Trial use ou Normative.
...
- Contrat de partenariat relatif à la mise à disposition de volets du CI_SIS ; <!-- TODO : Référencer le contrat UP_externe syntaxique -->
- Contrat de partenariat relatif à la mise à disposition de terminologies. <!-- TODO : Référencer le contrat UP_externe sémantique -->
